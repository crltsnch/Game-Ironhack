const wordList = [
    ...
    { word: "orquídea", hint: "Planta con flores exquisitas y complejas." },
    ...
    { word: "espectrofotometría", hint: "Medición de la intensidad de la luz absorbida o emitida por una sustancia." },
    { word: "circunlocución", hint: "Manera indirecta de expresar una idea." },
    ...
    { word: "ultracrepídariano", hint: "Que da opiniones sobre algo fuera de su competencia." },
    { word: "polimatía", hint: "Conocimiento enciclopédico." },
    { word: "efímero", hint: "De corta duración o vida breve." },
    { word: "anómalo", hint: "Que se aparta de lo común o sigue una norma inusual." },
    ...
    { word: "ópera", hint: "Género de música teatral en el que los personajes cantan sus partes." },
    { word: "xilófono", hint: "Instrumento musical de percusión con láminas de madera." },
    ...
    { word: "termodinámica", hint: "Estudio de la relación entre el calor y otras formas de energía." },
    { word: "potencia", hint: "Rapidez con la que se realiza trabajo." },
    { word: "metafísica", hint: "Rama de la filosofía que trata de los principios y fundamentos de la realidad." },
    { word: "universal", hint: "Lo que es común a todos los individuos de una especie." },
    { word: "fotón", hint: "Partícula elemental de luz." },
    ...
    { word: "melodía", hint: "Secuencia de sonidos armoniosos." },
    { word: "aventura", hint: "Experiencia emocionante o arriesgada." },
    { word: "tecnología", hint: "Conjunto de conocimientos y técnicas aplicadas a la producción y desarrollo de bienes y servicios." },
]
